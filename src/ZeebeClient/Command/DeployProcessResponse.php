...
class DeployProcessResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type int|string $key
     *           the unique key identifying the deployment
     *     @type array<\ZeebeClient\Command\ProcessMetadata>|\Google\Protobuf\Internal\RepeatedField $processes
     *           a list of deployed processes
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .gateway_protocol.ProcessMetadata processes = 2;</code>
     * @param array<\ZeebeClient\Command\ProcessMetadata>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProcesses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \ZeebeClient\Command\ProcessMetadata::class);
        $this->processes = $arr;
