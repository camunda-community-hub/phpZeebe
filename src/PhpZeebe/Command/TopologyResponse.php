...
class TopologyResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Community\PhpZeebe\Command\BrokerInfo>|\Google\Protobuf\Internal\RepeatedField $brokers
     *           list of brokers part of this cluster
     ...
     *
     * Generated from protobuf field <code>repeated .gateway_protocol.BrokerInfo brokers = 1;</code>
     * @param array<\Community\PhpZeebe\Command\BrokerInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBrokers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Community\PhpZeebe\Command\BrokerInfo::class);
        $this->brokers = $arr;
