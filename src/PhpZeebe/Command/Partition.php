...
class Partition extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkEnum($var, \Camundity\PhpZeebe\Command\Partition\PartitionBrokerRole::class);
        $this->role = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Camundity\PhpZeebe\Command\Partition\PartitionBrokerHealth::class);
        $this->health = $var;
