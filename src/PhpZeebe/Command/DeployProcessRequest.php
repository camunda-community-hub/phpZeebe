...
class DeployProcessRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Community\PhpZeebe\Command\ProcessRequestObject>|\Google\Protobuf\Internal\RepeatedField $processes
     *           List of process resources to deploy
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .gateway_protocol.ProcessRequestObject processes = 1;</code>
     * @param array<\Community\PhpZeebe\Command\ProcessRequestObject>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProcesses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Community\PhpZeebe\Command\ProcessRequestObject::class);
        $this->processes = $arr;
