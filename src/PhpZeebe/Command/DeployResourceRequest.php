...
class DeployResourceRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Community\PhpZeebe\Command\Resource>|\Google\Protobuf\Internal\RepeatedField $resources
     *           list of resources to deploy
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .gateway_protocol.Resource resources = 1;</code>
     * @param array<\Community\PhpZeebe\Command\Resource>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResources($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Community\PhpZeebe\Command\Resource::class);
        $this->resources = $arr;
